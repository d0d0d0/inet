...
#include "inet/networklayer/probabilistic/ProbabilisticDissector.h"
...
Register_Protocol_Dissector(&Protocol::probabilistic, ProbabilisticDissector);

void ProbabilisticDissector::dissect(Packet *packet, ICallback& callback) const
{
